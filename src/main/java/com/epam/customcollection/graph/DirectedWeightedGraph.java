...
public class DirectedWeightedGraph<E> implements Graph<E> {
  ...
  /**
   * Method to update the weight present between two nodes.
   * @param element1 representing node 1
   * @param element2 representing node 2
   * @param weight the weight with which the edge between them needs to updated
   * @throws ElementNotFoundException is the element passed are not found in the graph
   */
